...
syntax keyword racketSyntax #%module #%app #%integer-literal #%string-literal
syntax keyword racketSyntax define defun datatype define-macros
syntax keyword racketSyntax define-macro define-variadic-macro define-syntax-rule
syntax keyword racketSyntax example run import export meta group
syntax keyword racketConstant Syntax -> Integer Macro Type String IO ScopeAction Unit Bool
syntax keyword racketConstant Problem Maybe List Syntax-Contents Output-Port
"        + - * / abs negate > >= < <= = /= integer->string
syntax keyword racketFunc flip add remove unit true false
syntax keyword racketFunc module declaration type expression pattern type-pattern
syntax keyword racketFunc nothing just nil ::
syntax keyword racketFunc list-contents integer-contents string-contents identifier-contents
syntax keyword racketSyntax error syntax-error
syntax keyword racketSyntax the let let-syntax flet lambda if
syntax keyword racketSyntax quote unquote quasiquote quasiquote/loc
syntax keyword racketSyntax case type-case else with-unknown-type
syntax keyword racketSyntax case-integer pure
syntax keyword racketFunc zero succ
